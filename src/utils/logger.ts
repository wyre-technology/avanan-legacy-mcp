/**
 * Lightweight structured logger. All output goes to stderr so it does not
 * interfere with the MCP protocol on stdout (stdio transport).
 *
 * Configure via LOG_LEVEL: debug | info | warn | error (default: info).
 */
